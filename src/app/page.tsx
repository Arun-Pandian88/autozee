        ...
        <div className="hero-mockup-wrap">
          <div className="hero-mockup">
            ...
            <div className="hm-bar">
              ...
              <div className="hm-bar-url">app.autozee.in/inbox</div>
            ...
            <div className="hm-body">
              ...
              <div className="hm-sidebar">
                <div className="hm-s-logo">Az</div>
                {[
        ...
        <div className="lp-section-inner">
          ...
          <div className="price-enterprise">
            <div className="price-enterprise-inner">
              ...
              <a href="mailto:sales@autozee.in" className="price-enterprise-cta">Talk to sales →</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="lp-footer-inner">
          ...
          <div className="lp-footer-links">
            ...
            <div className="lp-footer-col">
              ...
              <a href="mailto:support@autozee.in" className="lp-footer-link">Support</a>
              <a href="mailto:sales@autozee.in" className="lp-footer-link">Contact sales</a>
